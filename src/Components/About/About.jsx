    ...
    return (
        <div className='bg-[#212428] pt-8 pb-10 lg:px-40'>
           ...
           <div className='text-white px-12 lg:px-20 mt-8 lg:w-1/2'>
                ...
                <p className='mt-4 text-gray-400 text-lg'>I am a junior front-end developer. Strong passion, love and self-improvement for technology and coding so far Frontend has learned - ReactJS, JavaScript, Tailwind CSS, Bootstrap, HTML, CSS also mobile responsive, all device responsive and various packages, frameworks, libraries. Also learned and learning for backend - MongoDB, NodeJS, Express.js, JWT, and Firebase.
...
Besides practice and work, I am constantly learning new things and love learning new technologies. I like taking on new challenges. My next target is to become a very good full-stack developer.
            ...
            <div className=' px-20'>
                <img className='rounded-full mt-6 lg:mt-8 max-h-96 border-4 border-red-700 w-h-64' src="https://i.ibb.co/fXzcS9J/IMG-20230524-213201-1.jpg" alt="" />
            </div>
           </div>
        </div>
    );
